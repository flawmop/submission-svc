...
import com.insilicosoft.portal.svc.simulation.config.SecurityConfig;
...
public class SimulationControllerIT {
  ...
  private static final GrantedAuthority userRole = new SimpleGrantedAuthority("ROLE_".concat(SimulationIdentifiers.ROLE_USER));
  ...
  class GetMethods {
    ...
    void testGet() throws Exception {
      ...
      mockMvc.perform(get(SimulationIdentifiers.REQUEST_MAPPING_SIMULATION).with(jwt().authorities(userRole)))
             //.andDo(print())
