package com.insilicosoft.portal.svc.rip.service.advice;
...
public class InputProcessorAdvice {
   ...
   */
  @AfterThrowing(pointcut = "execution(* com.insilicosoft.portal.svc.rip.service.InputProcessorService.process(..))",
                 throwing = "fpe")
