package com.insilicosoft.portal.svc.simulation.service.advice;
...
public class InputProcessorAdvice {
   ...
   */
  @AfterThrowing(pointcut = "execution(* com.insilicosoft.portal.svc.simulation.service.InputProcessorService.process(..))",
                 throwing = "fpe")
